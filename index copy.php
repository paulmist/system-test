...
<body>
	<div id="top_line">
		...
		<div class="right2">
			<div class="left3">
				<a href="http://www.webstarsltd.com/" target="_blank"><img src="images/logo.jpg" alt="" /></a>
			</div>
			<div class="right3">
				<a href="http://www.ntrglobal.com/ntrsupport/en-GB/login.asp?folder=en-GB" target="_blank"><img src="images/admin.png" alt="" /></a>
			</div>
			<div class="clear"></div>
		</div>
		<div class="clear"></div>
	...
	<div id="wrapper2">
		...
		<table class="tabel" id="theTable" border="0" cellspacing="1" cellpadding="3" width="400" style="display:none;">
			...
			<tr>
				...
				<td id="speed_test"><a href="http://www.speedtest.bbmax.co.uk/" target="_blank">Click here</a></td>
			</tr>
			<tr>
				<td width="24"><img src="images/support.png" alt="" /></td>
				<td width="100">Remote Support</td>
				<td id="speed_test"><a href="#" target="_blank">Download here</a></td>
			</tr>
		</table>
		</div>
		<div style="display:block;float:left;">
